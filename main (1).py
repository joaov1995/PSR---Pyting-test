...
def main():
    ...
    #Argument parser
    parser = argparse.ArgumentParser(description='PSR Typing Test |Bruno Duarte, Hugo Silva,  e João Vieira')
    ...
    print(Style.BRIGHT + 'Bruno Duarte, Hugo  Silva e João Vieira | Outubro 2023' + Style.RESET_ALL + '\n')
